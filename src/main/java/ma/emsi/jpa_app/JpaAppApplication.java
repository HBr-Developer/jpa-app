package ma.emsi.jpa_app;

import ma.emsi.jpa_app.entities.Patient;
import ma.emsi.jpa_app.repositories.PatientRepository;
    ...
    public void run(String... args) throws Exception {
        for(int i =0 ; i<100; i++){
            patientRepository.save(
                    new Patient(null,"hanane", new Date(),Math.random()>0.5?true:false, (int)(Math.random()*100)));
        }
